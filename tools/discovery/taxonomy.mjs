...
const ORIGINAL_TYPE_RULES = [
  ...
  ['カクヨム系', /カクヨム|カクヨム発/i],
  ['4コマ漫画系', /4\s*コマ(?:漫画)?|四コマ(?:漫画)?/i],
  ['ライトノベル系', /ライトノベル|ラノベ|light\s*novel/i],
  ['Web小説系', /web\s*小説|ウェブ小説|オンライン小説/i],
  ['ソーシャルゲーム系', /ソーシャルゲーム|スマホゲーム|スマートフォンゲーム|アプリゲーム/i],
  ['ノベルゲーム系', /ノベルゲーム|ビジュアルノベル|visual\s*novel|adv(?:ゲーム)?|アドベンチャーゲーム/i],
  ['カードゲーム系', /カードゲーム|tcg|トレーディングカード/i],
  ['ゲーム系', /ゲーム原作|ゲーム作品|ゲームを原作|game\s*original/i],
  ['児童文学系', /児童文学|児童書/i],
  ['一般小説系', /小説原作|小説を原作|一般小説|文芸作品/i],
  ['漫画系', /漫画原作|コミック原作|漫画を原作|コミックを原作/i],
  ['玩具系', /玩具原作|玩具企画|おもちゃ原作/i],
  ['特撮系', /特撮原作|特撮作品/i],
  ['舞台系', /舞台原作|演劇原作|舞台作品/i],
  ['音楽系', /楽曲原作|音楽原作|音楽企画/i],
  ['キャラクター企画系', /キャラクター企画|キャラクター原作/i],
  ['メディアミックス', /メディアミックス/i],
